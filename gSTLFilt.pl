...
$STLFilt_ID = "BD Software STL Message Decryptor v2.45 for gcc";
...
#
#			-width:nn			Set output line width (will break message lines at this column.)
#
...
# gcc map/multimap iterators:
	...
	s/\b_Rb_tree_iterator<pair<($t) ?const, ?($t)>, ?pair<\1const, ?\2> ?&, ?pair<\1const, ?\2> ?\*>/gen_map<$1,$2>::const_iterator/g;
